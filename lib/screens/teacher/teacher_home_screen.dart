...
Widget build(BuildContext context) {
  return Scaffold(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ...
                        _buildCard(
                          ...
                          icon: Icons.inbox,
                          description: 'Visualizar Respuestas Obtenidas',
                          color: const Color(0xFFFF7043),
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Ver Respuestas (Próximamente)')),
                            );
                          },
                        ),
                      ].map((card) {
    ...
    String? description, // <- nuevo campo opcional
  }) {
    return InkWell(
      onTap: onTap,
      ...
      child: Card(
        elevation: 6,
        shadowColor: color.withAlpha(102), // 102 ≈ 40% de opacidad
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                color.withAlpha(230), // ≈ 90%
                color.withAlpha(180), // ≈ 70%
              ],
